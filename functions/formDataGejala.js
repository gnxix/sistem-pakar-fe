...
document
  .getElementById("btnKeFormDataDiri")
  .addEventListener("click", function () {
...
document
  .getElementById("btnKeKonsultasi2")
  .addEventListener("click", function () {
    window.location.href = "Konsultasi.html";
  });

document
  .getElementById("btnKeFormDataDiri2")
  .addEventListener("click", function () {
    window.location.href = "formDataDiri.html";
  });
...
const gejalaData = [
  ...
  {
    kode: "G11",
    nama: "Dada terasa panas (heartburn), terutama setelah makan atau saat berbaring",
  },
  {
    kode: "G12",
    nama: "Naiknya makanan atau cairan asam dari lambung ke mulut",
  },
  ...
  {
    kode: "G31",
    nama: "Memiliki riwayat penyakit keluarga yang serius (penyakit lambung, diabetes, kanker, dsb.)",
  },
];
...
function populateGejalaTable() {
  ...
  updatePaginationInfo(); // Call function to update pagination info
}
